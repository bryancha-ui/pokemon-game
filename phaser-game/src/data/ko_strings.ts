...
export const KO_STRINGS: Record<string, string> = {
  ...
  'Eight badges — you did it. The Hanbando League is waiting; the Scholars\' Road opens from the Capitol now.': '배지 여덟 개 — 해냈구나. 한반도 리그가 기다려. 이제 학자의 길이 캐피톨에서 열려.',
  ...
  'The Capitol station is packed — the whole region has come to meet the trainer who conquered the Northern League.': '캐피톨 역이 인산인해다 — 북부 리그를 정복한 트레이너를 만나러 온 지역 전체가 모여들었다.',
  ...
  'Merchant: Welcome to the Capitol Central Market!': '상인: 캐피톨 중앙시장에 온 걸 환영해!',
  ...
  '📋 FLOORS\n1 Reception\n2 Medicine\n3 TMs\n4 Souvenirs\n5 Food Court\n6 Rooftop': '📋 층 안내\n1 안내\n2 약품\n3 기술머신\n4 기념품\n5 푸드코트\n6 옥상',
  '— Balcony over Capitol City —': '— 캐피톨 시티가 내려다보이는 발코니 —',
  'SPACE — Vending machine': 'SPACE — 자판기',
  'Receptionist: Welcome to the Capitol Department Store! Take the elevator up — six floors of everything a trainer needs.': '안내원: 캐피톨 백화점에 오신 걸 환영합니다! 엘리베이터를 타고 올라가세요 — 트레이너에게 필요한 모든 게 여섯 층에 있죠.',
  ...
  'Capitol City\'s secrets are now open to you. Journey on, trainer.': '이제 캐피톨 시티의 비밀이 네게 열렸어. 계속 나아가, 트레이너.',
  ...
  'Kisun: Hey! You must be heading to Capitol City for the first time!': '기선: 이봐! 캐피톨 시티에 처음 가는 길이구나!',
  ...
  'Rival: We started this whole thing racing each other to Capitol City. And now here we are — same city behind us, the very top of the region in front of us.': '라이벌: 우린 이 모든 걸 캐피톨 시티까지 서로 경주하며 시작했잖아. 그리고 지금 이렇게 — 같은 도시를 등지고, 지역의 맨 꼭대기를 눈앞에 두고 있어.',
