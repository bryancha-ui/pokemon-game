...
export class PyeongseongCheckpointScene extends Phaser.Scene {
  ...
  private createUI() {
    ...
    this.add.text(this.scale.width / 2, 22, '🛡 평성 관문 (Pyeongseong Checkpoint)', { fontSize: '13px', color: '#ffe9c0', fontStyle: 'bold' }).setOrigin(0.5).setScrollFactor(0).setDepth(51);
