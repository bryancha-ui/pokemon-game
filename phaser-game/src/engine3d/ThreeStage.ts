...
interface EnvColors {
  ...
  sun: number; sunIntensity: number; showSky: boolean;
}
...
const ENVS: Record<EnvProfile, EnvColors> = {
  ...
  cave:     { skyTop: 0x0c0c14, skyBottom: 0x26222e, fog: 0x141220, fogNear: 8, fogFar: 30,
              hemiSky: 0x4a4666, hemiGround: 0x201c28, hemiIntensity: 0.9, sun: 0x8f86c0, sunIntensity: 0.7, showSky: true },
  interior: { skyTop: 0x2a2634, skyBottom: 0x3c3648, fog: 0x2e2a38, fogNear: 18, fogFar: 44,
              hemiSky: 0xfff4e0, hemiGround: 0x776a58, hemiIntensity: 1.25, sun: 0xffeecc, sunIntensity: 1.1, showSky: false },
  battle:   { skyTop: 0x3f8be0, skyBottom: 0xd8ecff, fog: 0xcce2f8, fogNear: 30, fogFar: 90,
              hemiSky: 0xd8e8ff, hemiGround: 0x94a878, hemiIntensity: 1.25, sun: 0xfff4dc, sunIntensity: 1.75, showSky: true },
};
